...
2021.09.14
author: yasin sahin
written to construct a k-nearest neighboor model
...
x_1, x_2 = np.meshgrid(np.arange(start = x_set[:,0].min() - 10, stop = x_set[:,0].max() + 10, step = 8), \
                       np.arange(start = x_set[:,1].min() - 1000, stop = x_set[:,1].max() + 1000, step = 8))
